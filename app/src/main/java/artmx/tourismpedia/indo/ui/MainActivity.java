...
import artmx.tourismpedia.indo.BuildConfig;
import artmx.tourismpedia.indo.R;
import artmx.tourismpedia.indo.model.User;
import artmx.tourismpedia.indo.util.CircleTransform;
import artmx.tourismpedia.indo.util.Constants;
import artmx.tourismpedia.indo.util.Log;
import artmx.tourismpedia.indo.util.NotificationUtils;
import artmx.tourismpedia.indo.util.Utils;
...
public class MainActivity extends AppCompatActivity
    ...
    String mCityId, mCityName, mCityLat, mCityLng;
    ...
    private LinearLayout mSignInLayout, mNotification, mBookmarks;
    private Activity KulinerActivity;
...
*/
  ...
  /*      favoritesItem = navigationView.getMenu().findItem(R.id.nav_favorites);*/
        ...
        mNotification = (LinearLayout) headerLayout.findViewById(R.id.llnotification);
        mBookmarks = (LinearLayout) headerLayout.findViewById(R.id.iibookmark);
        ...
        mBookmarks.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent favIntent= new Intent(view.getContext(), FavoritesActivity.class);
                favIntent.putExtra("mUid", mUid);
                startActivity(favIntent);

                Toast.makeText(MainActivity.this, "test Bookmark", Toast.LENGTH_SHORT).show();
            }
        });

        LinearLayout kulinerMenu = (LinearLayout) this.findViewById(R.id.kuliner);
        LinearLayout wisataMenu = (LinearLayout) this.findViewById(R.id.wisata);
        LinearLayout hotelMenu = (LinearLayout) this.findViewById(R.id.hotel);
        LinearLayout eventMenu = (LinearLayout) this.findViewById(R.id.event);
        LinearLayout budayaMenu = (LinearLayout) this.findViewById(R.id.budaya);
        
        

        kulinerMenu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(view.getContext(), PlaceListActivity.class);
                intent.putExtra("cityLatLng", mCurrentLat + "," + mCurrentLng);
                ...
                Toast.makeText(MainActivity.this, "kuliner Click", Toast.LENGTH_SHORT).show();
            }
        });
        
        wisataMenu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(view.getContext(), PlaceListActivity.class);
                intent.putExtra("cityLatLng", mCurrentLat + "," + mCurrentLng);
                ...
                startActivity(intent);
                Toast.makeText(MainActivity.this, "wisata Click", Toast.LENGTH_SHORT).show();
            }
        });
        
        hotelMenu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(view.getContext(), PlaceListActivity.class);
                intent.putExtra("cityLatLng", mCurrentLat + "," + mCurrentLng);
                ...
                startActivity(intent);
                Toast.makeText(MainActivity.this, "hotel Click", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        budayaMenu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(view.getContext(), PlaceListActivity.class);
                intent.putExtra("cityLatLng", mCurrentLat + "," + mCurrentLng);
                ...
                startActivity(intent);
                Toast.makeText(MainActivity.this, "budaya Click", Toast.LENGTH_SHORT).show();
            }
        });
